...
package ${project.packageName}.${module.slug}.application.mappers.dto;
...
/** Mapping DTO for the ${model.name} model — a self-contained record used by the generated mappers. */
