...
public class IdentityProviderCrudOrchestrator extends Crud<
    ...
    final IdentityProviderCrudAdapter adapter;

    @Override
    public CrudAdapter<IdentityProviderViewModel, IdentityProviderViewModel, NoFilters, IdentityProviderRow, String> adapter() {
        return adapter;
    }
