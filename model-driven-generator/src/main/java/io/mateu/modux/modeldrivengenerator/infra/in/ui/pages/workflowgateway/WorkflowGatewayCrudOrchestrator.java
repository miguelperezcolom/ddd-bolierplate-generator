...
@Scope("prototype")
@Title("Workflow gateways")
public class WorkflowGatewayCrudOrchestrator extends Crud<
    ...
    final WorkflowGatewayCrudAdapter adapter;

    @Override
    public CrudAdapter<WorkflowGatewayViewModel, WorkflowGatewayViewModel,
            NoFilters, WorkflowGatewayRow, String> adapter() {
        return adapter;
    }
