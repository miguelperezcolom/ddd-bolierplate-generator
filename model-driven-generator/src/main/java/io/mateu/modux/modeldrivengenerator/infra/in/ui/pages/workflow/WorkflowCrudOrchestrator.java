...
@Title("Workflows")
@Slf4j
public class WorkflowCrudOrchestrator extends Crud<
        WorkflowViewModel,
        WorkflowViewModel,
        WorkflowViewModel,
        NoFilters,
    ...
    final WorkflowCrudAdapter adapter;

    @Override
    public CrudAdapter<WorkflowViewModel, WorkflowViewModel,
            NoFilters, WorkflowRow, String> adapter() {
        return adapter;
    }
