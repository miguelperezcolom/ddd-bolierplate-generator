...
@Scope("prototype")
@Title("Agentes IA")
public class AiAgentCrudOrchestrator extends Crud<
        AiAgentViewModel,
        AiAgentViewModel,
        AiAgentViewModel,
        NoFilters,
    ...
    final AiAgentCrudAdapter adapter;

    @Override
    public CrudAdapter<AiAgentViewModel, AiAgentViewModel, NoFilters, AiAgentRow, String> adapter() {
        return adapter;
    }
