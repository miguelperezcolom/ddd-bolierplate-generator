...
@Title("Decisions")
@Slf4j
public class DecisionCrudOrchestrator extends Crud<
        DecisionViewModel,
        DecisionViewModel,
        DecisionViewModel,
        NoFilters,
    ...
    final DecisionCrudAdapter adapter;

    @Override
    public CrudAdapter<DecisionViewModel, DecisionViewModel,
            NoFilters, DecisionRow, String> adapter() {
        return adapter;
    }
