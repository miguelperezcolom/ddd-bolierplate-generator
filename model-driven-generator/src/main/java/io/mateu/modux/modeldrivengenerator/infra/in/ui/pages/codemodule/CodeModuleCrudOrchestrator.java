...
@Scope("prototype")
@Title("Módulos de código")
public class CodeModuleCrudOrchestrator extends Crud<
        CodeModuleViewModel,
        CodeModuleViewModel,
        CodeModuleViewModel,
        NoFilters,
    ...
    final CodeModuleCrudAdapter adapter;

    @Override
    public CrudAdapter<CodeModuleViewModel, CodeModuleViewModel, NoFilters, CodeModuleRow, String> adapter() {
        return adapter;
    }
