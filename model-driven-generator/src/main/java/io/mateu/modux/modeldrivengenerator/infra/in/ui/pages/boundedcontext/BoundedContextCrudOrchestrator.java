...
@Scope("prototype")
@Title("BoundedContexts")
public class BoundedContextCrudOrchestrator extends Crud<
    ...
    final BoundedContextCrudAdapter adapter;

    @Override
    public CrudAdapter<
            BoundedContextViewModel, BoundedContextViewModel,
            NoFilters, BoundedContextRow, String> adapter() {
        return adapter;
    }
