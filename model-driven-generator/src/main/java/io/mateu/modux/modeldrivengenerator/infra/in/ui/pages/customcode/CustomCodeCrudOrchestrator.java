...
@Scope("prototype")
@Title("Código custom")
public class CustomCodeCrudOrchestrator extends Crud<
        CustomCodeViewModel,
        CustomCodeViewModel,
        CustomCodeViewModel,
        NoFilters,
    ...
    final CustomCodeCrudAdapter adapter;

    @Override
    public CrudAdapter<CustomCodeViewModel, CustomCodeViewModel, NoFilters, CustomCodeRow, String> adapter() {
        return adapter;
    }
