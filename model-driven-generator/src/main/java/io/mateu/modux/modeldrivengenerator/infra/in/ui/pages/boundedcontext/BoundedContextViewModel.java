...
import io.mateu.modux.modeldrivengenerator.application.usecases.boundedcontext.create.CreateBoundedContextCommand;
import io.mateu.modux.modeldrivengenerator.application.usecases.boundedcontext.create.CreateBoundedContextUseCase;
import io.mateu.modux.modeldrivengenerator.application.usecases.boundedcontext.save.SaveBoundedContextCommand;
import io.mateu.modux.modeldrivengenerator.application.usecases.boundedcontext.save.SaveBoundedContextUseCase;
...
public class BoundedContextViewModel implements Identifiable, CrudEditorForm<String>, CrudCreationForm<String> {
    ...
    public BoundedContextViewModel load(BoundedContextDto model) {
        id = model.id();
        name = model.name();
