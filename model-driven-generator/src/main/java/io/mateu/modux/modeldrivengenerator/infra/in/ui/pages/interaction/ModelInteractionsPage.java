...
/**
 * «Secuencias»: the CRUD of the authored interactions (sequence scenarios). Lists them with
 * their trigger and message count; the messages themselves are edited on the graphical
 * surface (docs/design/sequence-scenarios.md).
 */
@Service
@RequiredArgsConstructor
@Scope("prototype")
@Title("Secuencias")
public class ModelInteractionsPage extends Crud<
    ...
    final InteractionCrudAdapter adapter;

    @Override
    public CrudAdapter<InteractionViewModel, InteractionViewModel,
            NoFilters, InteractionRow, String> adapter() {
        return adapter;
    }
