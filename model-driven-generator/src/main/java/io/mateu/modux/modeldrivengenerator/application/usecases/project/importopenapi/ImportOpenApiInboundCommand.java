...
/**
 * Imports an OpenAPI document as the INBOUND contract of a module: one REST-exposed use case per
 ...
 */
public record ImportOpenApiInboundCommand(String moduleId, String filePath) {}
