...
@Scope("prototype")
@Title("Gateways MCP")
public class McpGatewayCrudOrchestrator extends Crud<
        McpGatewayViewModel,
        McpGatewayViewModel,
        McpGatewayViewModel,
        NoFilters,
    ...
    final McpGatewayCrudAdapter adapter;

    @Override
    public CrudAdapter<McpGatewayViewModel, McpGatewayViewModel, NoFilters, McpGatewayRow, String> adapter() {
        return adapter;
    }
