...
@Title("Flows")
@Slf4j
public class FlowCrudOrchestrator extends Crud<
        FlowViewModel,
        FlowViewModel,
        FlowViewModel,
        NoFilters,
    ...
    final FlowCrudAdapter adapter;

    @Override
    public CrudAdapter< FlowViewModel, FlowViewModel,
            NoFilters, FlowRow, String> adapter() {
        return adapter;
    }
