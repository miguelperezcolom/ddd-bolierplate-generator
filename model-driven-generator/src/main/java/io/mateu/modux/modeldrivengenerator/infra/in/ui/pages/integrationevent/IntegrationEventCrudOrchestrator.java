...
@Slf4j
public class IntegrationEventCrudOrchestrator extends Crud<
    ...
    final IntegrationEventCrudAdapter adapter;

    @Override
    public CrudAdapter< IntegrationEventViewModel, IntegrationEventViewModel,
            NoFilters, IntegrationEventRow, String> adapter() {
        return adapter;
    }
