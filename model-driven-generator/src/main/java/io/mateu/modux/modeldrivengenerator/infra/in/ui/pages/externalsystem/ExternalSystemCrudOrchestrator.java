...
public class ExternalSystemCrudOrchestrator extends Crud<
    ...
    final ExternalSystemCrudAdapter adapter;

    @Override
    public CrudAdapter<ExternalSystemViewModel, ExternalSystemViewModel, NoFilters, ExternalSystemRow, String> adapter() {
        return adapter;
    }
