...
public class TransformationCrudOrchestrator extends Crud<
    ...
    final TransformationCrudAdapter adapter;

    @Override
    public CrudAdapter<TransformationViewModel, TransformationViewModel, NoFilters, TransformationRow, String> adapter() {
        return adapter;
    }
