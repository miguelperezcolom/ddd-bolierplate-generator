...
public class IntegrationEvent {
    ...
    public static IntegrationEvent of(IntegrationEventId id, IntegrationEventName name, String boundedContextId, String description,
        ...
        event.id = id;
        event.name = name;
        event.boundedContextId = boundedContextId;
    ...
    public static IntegrationEvent load(String id, String name, String boundedContextId, String description,
                                        String sourceDomainEventId, String payloadModelId, String topicName,
                                        Integer partitions, Long retentionMs,
                                        IntegrationEventSerializationFormat serializationFormat,
                                        IntegrationEventCompressionType compressionType,
    ...
    public void update(IntegrationEventName name, String boundedContextId, String description,
                       String sourceDomainEventId, String payloadModelId, String topicName,
                       Integer partitions, Long retentionMs,
                       IntegrationEventSerializationFormat serializationFormat,
                       IntegrationEventCompressionType compressionType,
