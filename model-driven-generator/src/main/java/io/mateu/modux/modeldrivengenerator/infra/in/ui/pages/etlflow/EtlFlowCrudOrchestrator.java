...
@Scope("prototype")
@Title("Integraciones (ETL)")
public class EtlFlowCrudOrchestrator extends Crud<
        EtlFlowViewModel,
        EtlFlowViewModel,
        EtlFlowViewModel,
        NoFilters,
    ...
    final EtlFlowCrudAdapter adapter;

    @Override
    public CrudAdapter<EtlFlowViewModel, EtlFlowViewModel, NoFilters, EtlFlowRow, String> adapter() {
        return adapter;
    }
