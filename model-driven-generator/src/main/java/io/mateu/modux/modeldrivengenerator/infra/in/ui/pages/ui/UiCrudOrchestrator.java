...
@Scope("prototype")
@Title("UIs (interfaces)")
public class UiCrudOrchestrator extends Crud<
        UiViewModel,
        UiViewModel,
        UiViewModel,
        NoFilters,
    ...
    final UiCrudAdapter adapter;

    @Override
    public CrudAdapter<UiViewModel, UiViewModel, NoFilters, UiRow, String> adapter() {
        return adapter;
    }
