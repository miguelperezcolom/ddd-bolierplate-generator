...
public class Module {
    ...
    public static Module of(ModuleId id, ModuleName name, String gitRepository, List<AggregateId> aggregateIds, List<BddScenario> bddScenarios) {
    ...
    public static Module load(String id, String name, String gitRepository, List<String> aggregateIds, List<BddScenario> bddScenarios) {
        var module = new Module();
    ...
    public void update(ModuleName name, String gitRepository, List<AggregateId> aggregateIds, List<BddScenario> bddScenarios) {
        this.name = name;
