...
public class Project {
    ...
    public static Project load(String id, String name, String outputPath, String packageName, String gitRepository, List<String> services) {
        var project = new Project();
    ...
    public void update(ProjectName name, ProjectOutputPath outputPath, ProjectPackageName packageName, String gitRepository, List<ServiceId> services) {
        this.name = name;
