package io.mateu.modux.specdrivengenerator.domain.aggregates.role;
...
public class Role {
    ...
    private List<String> allowedReadModelIds;
    ...
    public static Role of(RoleId id, RoleName name,
        ...
        role.allowedReadModelIds = allowedReadModelIds != null ? allowedReadModelIds : List.of();
        return role;
    }
    ...
    public void update(RoleName name,
        ...
        this.allowedReadModelIds = allowedReadModelIds != null ? allowedReadModelIds : List.of();
    }
}
