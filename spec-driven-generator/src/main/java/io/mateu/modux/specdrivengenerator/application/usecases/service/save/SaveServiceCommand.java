package io.mateu.modux.specdrivengenerator.application.usecases.service.save;
...
public record SaveServiceCommand(String id, String name, String gitRepository, String dockerImageRegistry, String dockerImageName, Integer port, String contextPath, String database,
