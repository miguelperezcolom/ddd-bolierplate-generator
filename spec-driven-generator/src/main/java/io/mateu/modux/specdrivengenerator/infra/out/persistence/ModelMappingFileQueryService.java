...
import io.mateu.modux.specdrivengenerator.application.out.query.dtos.ModelMappingExpressionDto;
...
public class ModelMappingFileQueryService implements ModelMappingQueryService {
    ...
    private List<ModelMappingRuleDto> toRuleDtos(List<io.mateu.modux.specdrivengenerator.infra.out.persistence.file.ModelMappingRuleEntity> rules) {
