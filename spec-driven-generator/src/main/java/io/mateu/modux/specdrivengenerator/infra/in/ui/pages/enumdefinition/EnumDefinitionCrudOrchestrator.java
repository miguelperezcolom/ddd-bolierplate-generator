...
@Title("Enums")
@Slf4j
public class EnumDefinitionCrudOrchestrator extends CrudOrchestrator<
    ...
    final EnumDefinitionCrudAdapter adapter;

    @Override
    public CrudAdapter<EnumDefinitionViewModel, EnumDefinitionViewModel,
            NoFilters, EnumDefinitionRow, String> adapter() {
        return adapter;
    }
