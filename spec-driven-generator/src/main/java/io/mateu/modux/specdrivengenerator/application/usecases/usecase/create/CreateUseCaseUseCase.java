package io.mateu.modux.specdrivengenerator.application.usecases.usecase.create;
...
import io.mateu.modux.specdrivengenerator.domain.aggregates.usecase.vo.*;
...
public class CreateUseCaseUseCase {
    ...
    public void handle(CreateUseCaseCommand command) {
        var useCase = UseCase.of(
                ...
                command.grpcServiceName(), command.grpcMethodName());
